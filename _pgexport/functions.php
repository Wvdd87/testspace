...
function test_theme_setup() {
    ...
    register_nav_menus( array(
        ...
        'social'  => __( 'Social Links Menu', 'test_theme' ),
    ) );
...
if ( ! function_exists( 'test_theme_init' ) ) :
...
add_action( 'init', 'test_theme_init' );


if ( ! function_exists( 'test_theme_custom_image_sizes_names' ) ) :

function test_theme_custom_image_sizes_names( $sizes ) {
...
add_action( 'image_size_names_choose', 'test_theme_custom_image_sizes_names' );
endif;// test_theme_custom_image_sizes_names



if ( ! function_exists( 'test_theme_widgets_init' ) ) :
...
endif;// test_theme_widgets_init



if ( ! function_exists( 'test_theme_customize_register' ) ) :
...
endif;// test_theme_customize_register


if ( ! function_exists( 'test_theme_enqueue_scripts' ) ) :
    function test_theme_enqueue_scripts() {
    ...
    add_action( 'wp_enqueue_scripts', 'test_theme_enqueue_scripts' );
endif;
