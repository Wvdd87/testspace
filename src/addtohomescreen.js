...
ath.Class.prototype = {
	...
	show: function (force) {
		...
		this.element.style.cssText = '-webkit-transition-property:-webkit-transform,opacity;-webkit-transition-duration:0.3s;-webkit-transition-timing-function:ease-out;transition-property:opacity;transition-duration:0.3s;transition-timing-function:ease-out;';
	...
	_show: function () {
		...
		// kick the animation
		setTimeout(function () {
			that.element.style.webkitTransitionDuration = '0.3s';
			that.element.style.transitionDuration = '0.3s';
